...
class SelectVisitActivity : AppCompatActivity() {
    ...
    private lateinit var cardViewVisitaGuiada: CardView
    private lateinit var textoVisitaGuidada: TextView
    ...
    private fun initComponents() {
        ...
        cardViewVisitaGuiada = findViewById(R.id.CardViewVisitaGuiada)
        textoVisitaGuidada = findViewById(R.id.texto_select_visita_guiada)
    ...
    private fun initListeners() {
        ...
        cardViewVisitaGuiada.setOnClickListener{
            val siguientePantalla = Intent(this, SelectRolActivity::class.java)
            navigateToNextScreen(siguientePantalla, "guiada")
        }
    ...
    private fun navigateToNextScreen(siguientePantalla: Intent, tipoVisita: String) {
        ...
        when (tipoVisita) {
            ...
            "guiada" -> siguientePantalla.putExtra("visitaGuiada", "Visita Guiada")
        }
    ...
    private fun changeLanguage() {
        when (this.idiomaSeleccionado) {
            "esp" -> {
                ...
                textoVisitaGuidada.text = getString(R.string.texto_select_visit_visita_guiada)
            ...
            "eng" -> {
                ...
                textoVisitaGuidada.text = getString(R.string.texto_select_visit_visita_guiada_eng)
            ...
            "deu" -> {
                ...
                textoVisitaGuidada.text = getString(R.string.texto_select_visit_visita_guiada_deu)
            ...
            "fra" -> {
                ...
                textoVisitaGuidada.text = getString(R.string.texto_select_visit_visita_guiada_fra)
