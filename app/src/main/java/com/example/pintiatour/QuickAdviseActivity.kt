...
class QuickAdviseActivity : AppCompatActivity() {
    ...
    private var visitaGuiada: String? = ""
    ...
    private fun getSessionData() {
        ...
        } else if(intent.extras?.getString("visitaGuiada") != null){
            visitaGuiada = intent.extras?.getString("visitaGuiada")
    ...
    private fun initComponents() {
        ...
        textoTipoVisita = findViewById(R.id.texto_tipo_visita)
        ...
        textoTipoVisita.text = visitaExpress ?: visitaPersonalizada ?: visitaGuiada
    ...
    private fun initListeners() {
        ...
        btnVolver.setOnClickListener {
            ...
            else if(visitaGuiada != "" && visitaGuiada != null){
                siguientePantalla = Intent(this, SelectRolActivity::class.java)
            }
    ...
    private fun changeLanguage() {
        ...
        val languageMapping = mapOf(
            "esp" to mapOf(
                ...
                "textoGuiada" to R.string.texto_select_visit_visita_guiada,
            ...
            "eng" to mapOf(
                ...
                "textoGuiada" to R.string.texto_select_visit_visita_guiada_eng,
            ...
            "deu" to mapOf(
                ...
                "textoGuiada" to R.string.texto_select_visit_visita_guiada_deu,
            ...
            "fra" to mapOf(
                ...
                "textoGuiada" to R.string.texto_select_visit_visita_guiada_fra,
        ...
        textoTipoVisita.text = if (intent.extras?.getString("visitaPersonalizada") != null)
            ...
            getString(languageResources["textoGuiada"] ?: R.string.texto_select_visit_visita_guiada)
        else
